...
[![npm version](https://badge.fury.io/js/%40liemle3893%2Fn8n-mcp-server.svg)](https://badge.fury.io/js/%40liemle3893%2Fn8n-mcp-server)

🔗 **Repository**: [github.com/liemle3893/n8n-mcp-server](https://github.com/liemle3893/n8n-mcp-server)
...
```bash
# Pull the image
docker pull liemle3893/n8n-mcp-server
...
If you installed the server using `npm install -g @liemle3893/n8n-mcp-server`:

1.  Open your terminal or command prompt.
2.  Run the following command to get the latest version:
    ```bash
    npm install -g @liemle3893/n8n-mcp-server@latest
    ```
...
1.  Pull the latest image from Docker Hub:
    ```bash
    docker pull liemle3893/n8n-mcp-server:latest
    ```
...
3.  Start a new container with the updated image. Use the same `docker run` command you used previously, including all your necessary environment variables (refer to the "Docker Installation" section for an example command). For instance:
    ...
    docker run -e N8N_API_URL=http://your-n8n:5678/api/v1 \
      ...
      -e N8N_WEBHOOK_USERNAME=username \
      -e N8N_WEBHOOK_PASSWORD=password \
      liemle3893/n8n-mcp-server:latest
    ```
...
- `list_workflows`: Retrieve a list of all workflows available in n8n
- `get_workflow`: Retrieve a specific workflow by ID
- `create_workflow`: Create a new workflow in n8n
- `update_workflow`: Update an existing workflow in n8n
- `delete_workflow`: Delete a workflow from n8n
- `activate_workflow`: Activate a workflow in n8n
- `deactivate_workflow`: Deactivate a workflow in n8n

### Execution Management

- `list_executions`: Retrieve a list of workflow executions from n8n
- `get_execution`: Retrieve detailed information about a specific workflow execution
- `delete_execution`: Delete a specific workflow execution from n8n
- `run_webhook`: Execute a workflow via webhook with optional input data

### System Tools

- `health_check`: Check n8n instance health and connectivity
- `get_credentials`: List available credentials (read-only for security)
...
Please share your thoughts, feature requests, and ideas by opening an issue on our [GitHub Issues page](https://github.com/liemle3893/n8n-mcp-server/issues). Let's build a powerful tool for AI assistants together!
...
If you encounter a bug, please report it by opening an issue on our [GitHub Issues page](https://github.com/liemle3893/n8n-mcp-server/issues).
...
We're always looking for ways to make the server better. If you have an idea for an enhancement or a new feature, please open an issue on our [GitHub Issues page](https://github.com/liemle3893/n8n-mcp-server/issues).
...
1.  **Fork the repository:** Create your own fork of the [n8n-mcp-server repository](https://github.com/liemle3893/n8n-mcp-server).
...
1.  Check out our [GitHub Issues page](https://github.com/liemle3893/n8n-mcp-server/issues) to find existing tasks, suggest new ideas, or express your interest in becoming a co-maintainer.
...
[![Star History Chart](https://api.star-history.com/svg?repos=liemle3893/n8n-mcp-server&type=Date)](https://www.star-history.com/#liemle3893/n8n-mcp-server&Date)
